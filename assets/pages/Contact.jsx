...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Arcadia Zoo - Contact</title>
        <meta
          name="description"
          content="N'hésitez pas à nous contacter pour toute question ou demande de renseignement. Nous vous repondrons dans les plus brefs délais."
        />
      </Helmet>
